...
<html lang="en">
  <head>
    ...
    <title>Xem thông tin cá nhân sinh viên</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Xem thông tin cá nhân sinh viên </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Báo cáo tiến độ</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Xem thông tin cá nhân sinh viên</li>
                </ol>
              </nav>
            </div>
            <div class="row">
...
<td colspan="4" style="font-size:20px;color:blue">Thông tin chi tiết về sinh viên</td></tr>
