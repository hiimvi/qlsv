        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Thông tin cá nhân Admin </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Báo cáo tiến độ</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Thông tin cá nhân Admin</li>
                </ol>
              </nav>
            </div>
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Thông tin cá nhân Admin</h4>
...
{               ?>
                      ...
                      <div class="form-group">
                        <label for="exampleInputPassword4">SĐT</label>
