        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Cập nhật về trang giới thiệu </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Báo cáo tiến độ</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Cập nhật về trang giới thiệu</li>
                </ol>
              </nav>
            </div>
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Cập nhật về trang giới thiệu</h4>
...
{               ?>      
                      <div class="form-group">
                        <label for="exampleInputName1">Tiêu đề trang:</label>
                        <input type="text" name="pagetitle" value="<?php  echo $row->PageTitle;?>" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Mô tả trang:</label>
