                    ...
                    <form method="post">
                                <div class="form-group">
                                   <strong>Tìm kiếm sinh viên:</strong>
                                    ...
                                    <input id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Tìm bằng ID sinh viên"></div>
...
$sdata=$_POST['searchdata'];
  ?>
  <h4 align="center"> "<?php echo $sdata;?>" từ khóa </h4>
                    </div>
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Lớp sinh viên</th>
...
$cnt=$cnt+1;
  ...
  <tr>
    <td colspan="8"> Sai! Vui lòng tìm kiếm lại</td>
